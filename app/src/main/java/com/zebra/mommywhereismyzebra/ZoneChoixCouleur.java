...
public class ZoneChoixCouleur extends View {
    ...
    */
    ...
    public ZoneChoixCouleur(Context context) {
        this(context, null);
    }

    public ZoneChoixCouleur(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ZoneChoixCouleur(Context context, AttributeSet attrs, int defStyle) {
